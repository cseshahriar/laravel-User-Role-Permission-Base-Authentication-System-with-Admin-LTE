      ...
      <!--------------------------
        ...
        <div class="col-md-8"> 
            <div class="panel panel-primary">
                <div class="panel-heading bg-primary">Update Product</div> 
                <div class="panel-body">
                    ...
                    @include('admin.partials.errors')  
                      ...
                      <div class="form-group"> 
                          ...
                          <textarea name="short_description" id="editor" class="form-control " rows="5" cols="5">{{ $product->short_description }}</textarea>
                      </div>  

                      <div class="form-group"> 
                          <label class="form-control-label">Description </label>
                          <textarea name="description" id="editor" class="form-control " rows="6" cols="6">{{ $product->description }}</textarea>
                      </div>

                    <div class="form-group">
                      <label class="form-control-label">SEO Title</label>
                      <input type="text" name="meta_title" id="meta_title" class="form-control" placeholder="SEO Title" value="{{ $product->meta_title }}"> 
                    </div> 
                
                    <div class="form-group">
                      <label class="form-control-label">SEO Keywords</label>
                      <textarea name="meta_keywords" id="meta_keywords" cols="3" rows="3" class="form-control" placeholder="SEO Keywords">{{ $product->meta_keywords }}</textarea>
                    </div> 
                
                    <div class="form-group">
                      <label class="form-control-label">SEO Description</label> 
                       <textarea name="meta_description" id="meta_description" cols="3" rows="3" class="form-control" placeholder="SEO Description"> {{ $product->meta_description }}</textarea> 
                    </div> 
        ...
        <div class="col-md-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body"> 
                      ...
                      <div class="form-group"> 
                          <img src="{{ asset('storage/'.$product->thumbnail )}}" alt="" class="img-thumbnail"> <br>
                      ...
                      <div class="form-group">
                        ...
                        @endphp
                          ...
                          <select name="parent_id[]" id="parent_id" class="select2 form-control" multiple="multiple"> 
                            ...
                            @foreach($product_categories as $oldProduct_categorie)
                              @foreach($categories as $cat)
                              <option value="{{ $cat->id }}" {{ $oldProduct_categorie->category_id == $cat->id ? 'selected' : '' }}>{{$cat->title}}
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="qty" id="qty" class="form-control" placeholder="Quantity" value="{{ $product->qty }}"> 
                      </div>  

                      <div class="form-group">
                        <label class="form-control-label">Stock Keeping Unit </label>
                        <input type="number" name="sku" id="sku" class="form-control" placeholder="SKU" value="{{ $product->sku }}">
                      </div>  

                      <div class="form-group">
                        <label class="form-control-label">Special Price</label>
                        <input type="number" name="special_price" id="price" class="form-control" placeholder="Special Price" value="{{ $product->special_price }}">
                      </div>   

                      <div class="form-group">
                        <label class="form-control-label">Special Price Start</label>
                        <input type="text" name="special_price_start" id="special_price_start" class="form-control datepicker" placeholder="Special Price Start" value="{{ $product->special_price_start }}"> 
                      </div>   

                      <div class="form-group">
                        <label class="form-control-label">Special Price End</label>
                        <input type="text" name="special_price_end" id="special_price_end" class="form-control datepicker" placeholder="Special Price End" value="{{ $product->special_price_end }}"> 
                      </div>    

                      <div class="form-group">
                        <label class="form-control-label">New Form Date</label>
                        <input type="text" name="new_from" id="new_from" class="form-control datepicker" placeholder="New from date" value="{{ $product->new_from }}">
                      </div>   

                      <div class="form-group">
                        <label class="form-control-label">New To Date</label>
                        <input type="text" name="new_to" id="new_to" class="form-control datepicker" placeholder="New Date End" value="{{ $product->new_to }}"> 
                      </div> 
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group row" id="attributeDiv"> 
                    ...
                    @foreach($product_attributes as $oldProductAttr) 
                    <div id="attBox">   
                      <div class="form-group col-md-5">
                        ...
                        <select name="attribute_key[]" id="attribute_key" class="form-control">
                          ...
                          <option value="{{ $attribute->name }}" {{ $oldProductAttr->attribute_key== $attribute->name ? 'selected' : ''}}>{{ $attribute->name }}</option>
                          @endforeach
                        </select> 
                      </div>
                      ...
                      <div class="form-group col-md-5">
                        ...
                        <input type="text" name="attribute_value[]" id="attribute_value" placeholder="Value" class="form-control" value="{{ $oldProductAttr->attribute_value }}">  
                      </div>
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group" id="image_div">
                          @foreach($product_images as $oldProduct_image)
                          <img src="{{ asset('storage/'.$oldProduct_image->image) }}" alt="" class="img-thumbnail" style="margin-bottom: 15px">
